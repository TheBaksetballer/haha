...
gameOver.scale = 0.5;
  restart=loadImage("pictures/restart.png");
restart.scale = 0.5;

gameOver.visible = false;
restart.visible = false;

spaceship = createSprite(300,300, 100, 100); 
  spaceship=loadImage("pictures/unnamed(29).png");
spaceship.scale = 0.5;
spaceship.x = 200;
}
...
textStyle(BOLD);
  ...
  if(keyDown("space"))
  {
    ...
    var laser = createSprite(spaceship.x,spaceship.y,10,30);
    ...
    if(count===20)
    {
      if(World.frameCount % 1000 === 0)
      {
        for (var n = 0; n < 400; n = n +20) 
        {
          ...
          black.scale = 0.2
            black=loadImage("pictures/background.png");
        }
      }
      if (enemyGroup.y===400 ){ 
        gameState = END
